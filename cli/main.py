...
def cli():
    ...
    # live subcommand — browser-based Svelte UI
    live_parser = subparsers.add_parser(
        "live",
        help="Start the FastAPI backend and serve the Svelte web UI in a browser.",
    )
    live_parser.add_argument(
        "--port", type=int, default=58421,
        help="Port to run the server on (default: 58421)",
    )
    live_parser.add_argument(
